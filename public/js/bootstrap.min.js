...
//# sourceMappingURL=bootstrap.min.js.map
      ...
      //===== menu-active-tab =====//
      let navbarUl = document.querySelector('[data-js="nav-bar"]');
      let navbarTabs = document.querySelectorAll('[data-js="nav-tab"]');
      navbarUl.addEventListener('click', function (e) {
        let cible = e.target;

        if(cible.dataset.js == "nav-tab"){
          let elNav = cible;
          navbarTabs.forEach(navTab => {
