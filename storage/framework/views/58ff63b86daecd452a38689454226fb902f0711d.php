...
<?php $__env->startSection('title', trans('lang.add_new_post')); ?>
            ...
            <div class="row">
                <div class="col-md-12 d-flex justify-content-end">
                    <a href="<?php echo e(route('blog.create')); ?>" class="btn btn-outline-info">
                        <?php echo app('translator')->get('lang.add_new_post'); ?>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="container mb-5">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <h2 class="heading-section text-white"><?php echo app('translator')->get('lang.article_list'); ?></h2>
                </div>
            </div>
            <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <?php if($locale === "fr"): ?>
                                        ...
                                        <td class="align-middle"><?php if(!$blog->body_fr): ?> <?php echo e(Str::limit($blog->body, 30)); ?> <?php else: ?> <?php echo e(Str::limit($blog->body_fr, 30)); ?> <?php endif; ?></td>
                                    <?php else: ?>
                                        ...
                                        <td class="my-2"><?php if(!$blog->body): ?> <?php echo e(Str::limit($blog->body_fr, 30)); ?> <?php else: ?> <?php echo e(Str::limit($blog->body, 30)); ?> <?php endif; ?></td>
                                    <?php endif; ?>
                                ...
                                <td class="text-danger align-middle"><?php echo app('translator')->get('lang.article_empty'); ?></td>
                                <?php endif; ?>
                            </tbody>
                        </table>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web21647\CadricielWeb\FavreauTommy-TP2\Maisonneuve2295379\resources\views/blog/index.blade.php ENDPATH**/ ?>