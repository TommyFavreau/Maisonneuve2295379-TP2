@extends('layouts.app')
@section('title', trans('lang.article_user_list'))
@section('content')
        ...
        <div class="container mb-5">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <h2 class="heading-section text-white">@lang('lang.article_user_list')</h2>
                </div>
            </div>
            <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    @if ($locale === "fr")
                                        ...
                                        <td class="align-middle">@if (!$blog->body_fr) {{ Str::limit($blog->body, 50) }} @else {{ Str::limit($blog->body_fr, 50) }} @endif</td>
                                    @else
                                        ...
                                        <td class="align-middle">@if (!$blog->body) {{ Str::limit($blog->body_fr, 50) }} @else {{ Str::limit($blog->body, 50) }} @endif</td>
                                    @endif
                                ...
                                @empty
                                <td class="text-danger">@lang('lang.article_empty')</td>
                                @endforelse
                            </tbody>
                        </table>
                        <div class="d-flex justify-content-center m-2">
