@extends('layouts.app')
@section('title', trans('lang.modify_post'))
@section('content')
    ...
    <div class="container">
        <div class="form-holder">
            <div class="form-content">
                <h1 class="display-one"> @lang('lang.modify_post') </h1>
                ...
                <div class="form-items border-thick-rounded m-3">
                    ...
                    <form method="post">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="nav-fr" role="tabpanel" aria-labelledby="nav-fr-tab" tabindex="0">
                                ...
                                <div class="mt-3 form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="body_fr" name="body_fr" rows="3">{{ $blog->body_fr}}</textarea>
                                    </div>
                        ...
                        <div class="form-button mt-3">
                            <input type="submit" value="@lang('lang.modify')" class="btn btn-outline-warning">
